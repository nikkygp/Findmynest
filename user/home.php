...
include "../config.php";
include "header.php"; 
$query = "SELECT * FROM tbl_ads WHERE ad_feature = 'yes' and username != '$email' and status = 2";
$res = mysqli_query($conn,$query);
$query1 = "SELECT * FROM tbl_ads WHERE  ad_feature = 'no' and username != '$email' and status = 2";
...
<section class="grids-4" id="properties" tabindex="0" style="outline:none;">
    <div id="grids4-block" class="py-2">
            <?php
            {
                echo '<div class="container py-md-6">';
                    ...
                    echo '<div class="grids4-info  col-lg-3 col-md-3 mb-3">
                        <a href="adview.php?ad_id='.$encryption.'"><img src="Property_images/'.$row['image1'].'"  class="img-fluid" height="200px" width="300px" alt=""></a>
                        ...
                        if($row['ad_cat']=='Rent')
                        {
                          ...
                          ');
                            ...
                            echo '<p><a href="adview.php?ad_id='.$encryption.'">'.$row['ad_title'].'</a></p>
                    ...
                    while ($row = mysqli_fetch_array($res1))
                    {
                        ...
                        $encryption = openssl_encrypt($simple_string, $ciphering,
                                    $encryption_key, $options, $encryption_iv);
                        echo '<div class="grids4-info  col-lg-3 col-md-3 mb-3">
                                <a href="adview.php?ad_id='.$encryption.'"><img src="Property_images/'.$row['image1'].'" height="200px" width="300px" class="img-fluid" alt=""></a>
                                <ul class="location-top">
                                    <li class="rent">For '.$row['ad_cat'].'</li>
                                    <li class="open-1">'.$row['ad_type'].'</li>
                                </ul>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Enter city,place or town</h5>
            ...
            <div class="container">
                <div class="column1">
                        <form action="#" method="post" autocomplete="off">
                            <div class="blog-search form d-flex flex-column search-form">
                                <input id="location" name="loc" id="fname" type="text" class="form-control rounded" placeholder="Enter Location, Property, Landmark" required/>
                            <span id="name" class="er"><font size="2">Please enter a valid name!!</font></span>
                            </div><br>
                            <button type="submit" name="search" class="btn btn-primary mt-3">Submit</button>
                        </form>
                </div>
            </div>
          </div>
