...
$s_id = $_GET['s_id'];
$loc = $_SESSION['s_loc'];
$query = "SELECT * FROM tbl_agents WHERE agent_id = '$s_id'";
$r = mysqli_query($conn,$query);
$row_res = mysqli_fetch_array($r);
$name = $row_res['name'];
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="col-4">
                                ...
                                <label for="inputAddress2" class="form-label">Location</label>
                                    <input type="text" class="form-control" id="loc" name="loc" value="<?php echo $row_res['place']; ?>" required="required" disabled>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                              ...
                              <div class="col-4">
                                ...
                                <input type="text" name="feature" value="yes" hidden>
                                <input type="text" name="createdDate" value="<?php echo $c_date; ?>" hidden>
                                <div class="col-12 mt-4">
                                  <button type="submit" name="post_ad_btn" id="lbtn" class="btn-primary">Proceed to Checkout</button>
...
<?php
include 'useradControllerfeature.php';
include 'footer.php';
?> 