        ...
        <div class="container">
            <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                <div class="profile-tab-nav1">
                  <h3 class="mb-4 ml-5 mt-5">Tell us about your property</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="des" name="des" placeholder="Describe about your property" rows="4"></textarea>
                                </div>
                             ...
                             <div class="col-md-6">
                              ...
                              <div class="col-4">
                                ...
                                <div class="form-group">
                                    <label for="inputCity" class="form-label">Do you want to Feature your Ad ?(Rates apply)</label>
                                </div>
                                </div>
                                <div class="col-md-4 mt-4">
                                  <div class="form-group">
                                  <input type="radio" class="form-radio" name="feature" id="inputEmail4" required="required" value="yes"> Yes
                                </div>
                                </div>
                                <div class="col-md-4 mt-4">
                                  <div class="form-group">
                                  <input type="radio" class="form-radio" name="feature" id="inputEmail4" required="required" value="no"> No
                                </div>
                                </div>
