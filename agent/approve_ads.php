...
include 'header.php';
$user = $_SESSION['email'];
$query = "SELECT * FROM tbl_ads WHERE seller_email = '$user' and status = 2";
$res = mysqli_query($conn,$query);
?>
<div class="heading text-center mx-auto mt-5">
   <h3 class="head">Approved Ads</h3>
</div>
...
{
    echo('<center><font color="red" size="3">No Ads Approved!!</font></center>');
}
?>
