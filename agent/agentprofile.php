...
$query = "SELECT * FROM tbl_agents WHERE email = '$email' and status = 1";
            ...
            <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                ...
                <div class="tab-content p-2 p-md-5" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="commission" value="<?php echo $_SESSION['commission']; ?>" id="price" disabled>
                                </div>
                        ...
                        <div>
                            <input class="btn btn-primary" type="submit" name="ubtn" id="btn" value="Update" disabled>
                    ...
                    <?php
                      include "../config.php";
                        if(isset($_POST['ubtn']))
                        {
                            ...
                            $phone1 = $_POST['phone'];
                            $place1 = ucwords($_POST['place']);
                            $commission = $_POST['commission'];
                            $address1 = $_POST['address'];
                            $sql = "UPDATE `tbl_agents` SET `address`='$address1',`phone`='$phone1',`place`='$place1' ,`commission` = '$commission' WHERE email = '$email'";
                        ...
                        if(isset($_POST['pbtn']))
                        {
                             ...
                             if(($npass == "")||($cpass == ""))
                              ...
                              {
                                $sql = "UPDATE tbl_agents SET password = '$npass_encrypt' WHERE email = '$email'";
                                $res = mysqli_query($conn,$sql);
                                if($res)
                                {
                                    echo ("<script LANGUAGE='JavaScript'>
                    ...
                    <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary" name="pbtn">Change Password</button>
                            <button class="btn btn-light">Cancel</button>
                        </div>
                    </div>
                </form>
